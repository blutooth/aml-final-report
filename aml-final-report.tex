...
\todo{Proofread the paper for flow}

\section{Introduction:}

\todo{The report should describe the rationale for selecting the paper
...
\todo{Provide analysis}

\todo{Make up some tables about effective sample size and how the reduction
in likelihood evaluations is bigger than the drop in ESS}
...
\todo{Write this section, make sure the mention extension work including: minimizing bound over posterior samples
instead of MAP tuning (see  ```MAP-tuning the lower bound'')}
