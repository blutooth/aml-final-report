...
Note that for any point $x_{n}$,\autoref{eq:brightness} implies the probability
$x_{n}$ is bright is given by
...
Table~\autoref{tb:ess}. The results are based using, the corresponding
MCMC sampler.
